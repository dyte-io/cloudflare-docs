...
- [List recordings](/api/resources/realtime_kit/subresources/recordings/methods/list/):
  This endpoint gets all past and ongoing recordings linked to a meeting.
- [Fetch active recording](/api/resources/realtime_kit/subresources/recordings/methods/active/): This
  endpoint gets all ongoing recordings of a meeting.
- [Fetch details of a recording](/api/resources/realtime_kit/subresources/recordings/methods/get/): This
