...
For more information on how to set your external storage configuration, see [Publish Recorded File to Your Cloud Provider](/realtime/realtimekit/recording/custom-cloud-storage/).
