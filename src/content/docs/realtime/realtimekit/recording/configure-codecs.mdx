...
the [Start Recording API](/api/resources/realtime_kit/subresources/recordings/methods/create/), for
example:
...
The video file for your recording is generated only if you passed the `video_config` parameters in the [Start Recording API](/api/resources/realtime_kit/subresources/recordings/methods/create/).

When the recording is completed, you can use the `downloadUrl` provided in the response body of the [Start Recording API](/api/resources/realtime_kit/subresources/recordings/methods/create/) to download and export the video file.
