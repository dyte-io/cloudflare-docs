...
:::note[Prerequisites]
This page builds upon the [Render Default Meeting UI](/realtime/realtimekit/ui-kit/) and [Build Your Own UI](/realtime/realtimekit/ui-kit/build-your-own-ui/) guides. Make sure you've read those first.
:::
