...
:::note[Prerequisites]
This page builds upon the [Render Default Meeting UI](/realtime/realtimekit/ui-kit/) guide and [Build Your Own UI](/realtime/realtimekit/ui-kit/build-your-own-ui/). Make sure you've read those first.
:::
