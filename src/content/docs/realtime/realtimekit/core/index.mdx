...
If you don't have a participant auth token, please follow the [Participant Creation](/realtime/realtimekit/concepts/participant/) guide to create one.
:::
...
`meeting` object is the main entry point to the RealtimeKit SDK. It provides methods to control the peer in the session. For more details, see the [Meeting Object Explained](/realtime/realtimekit/core/meeting-object-explained/).
