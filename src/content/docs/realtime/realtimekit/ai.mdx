...
You can create a new preset on the Developer Portal or using the [REST API](/realtime/api/).
...
For webhook format details, refer to [Webhooks](/realtime/realtimekit/webhooks/).
...
1. [Create a meeting](/realtime/api/)
2. [Add a participant](/realtime/api/) to the meeting. Make sure that the preset you use was configured according to this guide
...
- [Webhooks](/realtime/realtimekit/webhooks/) - Set up webhooks for AI events
- [API](/realtime/api/) - Complete API reference for transcription and summarization