...
:::note[Prerequisites]
This page assumes you've already initialized the SDK as described in the [Initialize SDK](/realtime/realtimekit/initialize-sdk/) guide.
:::
...
console.log('First Participant Screen Share Enabled:', firstParticipant?.screenShareEnabled);          // Screen share state
...
console.log('First Participant Screen Share Track:', firstParticipant?.screenShareTracks);          // Screen share MediaStreamTrack
...
- [Core SDK Reference](https://docs.realtime.cloudflare.com/web-core/reference/RealtimeKitClient)
- [RTKSelf Reference](https://docs.realtime.cloudflare.com/web-core/reference/RTKSelf)
- [RTKParticipants Reference](https://docs.realtime.cloudflare.com/web-core/reference/RTKParticipants)
</TabItem>
</Tabs>
