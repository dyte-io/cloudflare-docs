...
```
For a complete list of all available configuration parameters, refer to the [Create Preset API](/api/resources/realtime_kit/subresources/presets/methods/create/).
...
![Preset editor in the Cloudflare dashboard](../assets/preset_editor.png)
