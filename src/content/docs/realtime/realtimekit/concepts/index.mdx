...
It also define the meeting type a user joins—video call, audio call, webinar, or livestream. Participants in the same meeting can use different presets to create flexible roles.
...
It also let you customize the UI’s look and feel, including colors and themes, so the experience matches your app’s branding.
