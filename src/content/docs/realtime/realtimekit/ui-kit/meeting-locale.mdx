...
:::note[Prerequisites]
This page builds upon the [Render Default Meeting UI](/realtime/realtimekit/ui-kit/) & [Build Your Own UI](/realtime/realtimekit/ui-kit/) guides. Make sure you've read it first and understand how to use the default meeting UI components.
:::
