...
[Get Started with RealtimeKit](/realtime/realtimekit/get-started/) to familiarize yourself with RealtimeKit.
...
- Using the [Start Recording API](/api/resources/realtime_kit/subresources/recordings/methods/create/)
- Client side start recording methods on the SDK

RealtimeKit stores recordings for a period of 7 days, after which they will expire and no longer be accessible. It is important to either download a copy of your recording or [set up storage](/realtime/realtimekit/recording/custom-cloud-storage/) before the link expires.
...
4. There can only be one active recording of a meeting at any given time, unless the `allow_multiple_recording` field is set in the [Start Recording API](/api/resources/realtime_kit/subresources/recordings/methods/create/).
5. Maximum recording time is 24 hours. Recording will automatically stop after
   ...
   in the [Start Recording API](/api/resources/realtime_kit/subresources/recordings/methods/create/) request.
...
[Start Recording API](/api/resources/realtime_kit/subresources/recordings/methods/create/).

Specify the `meeting ID` of the meeting that you want to record.

Use the [List meetings API](/api/resources/realtime_kit/subresources/meetings/methods/list/) for an
