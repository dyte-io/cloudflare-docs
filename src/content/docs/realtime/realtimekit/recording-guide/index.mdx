...
2. RealtimeKit generates a downloadable link from which the recording can be
   ...
   [Fetch details of a recording API](/api/resources/realtime_kit/subresources/recordings/methods/get/)
   ...
   - Using the [Fetch active recording API](/api/resources/realtime_kit/subresources/recordings/methods/active/).
...
3. Download the recording from the download url and store it to your cloud
   ...
   [Fetch active recording API](/api/resources/realtime_kit/subresources/recordings/methods/active/) or
   ...
   [Start recording a meeting API](/api/resources/realtime_kit/subresources/recordings/methods/create/).

## Workflow

A typical workflow for recording a meeting involves the following steps:

1. Start a recording using the [Start Recording API](/api/resources/realtime_kit/subresources/recordings/methods/create/) or client side SDK.
2. Stop the recording using the [Stop Recording API](/api/resources/realtime_kit/subresources/recordings/methods/update/) or client side SDK.
3. Fetch the download URL for downloading the recording using the [Fetch Recording Details API](/api/resources/realtime_kit/subresources/recordings/methods/get/), webhook, or from the Developer Portal.
