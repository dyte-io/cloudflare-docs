...
This guide explains how to use Cloudflare RealtimeKit SDKs to build fully custom real-time video UIs. It covers SDK architecture, integration patterns for various frameworks, and provides practical code samples for both default and custom UI implementations.

### Build Your Own UI - Code Samples

If you’d like a head start, please feel free to explore our sample code repositories, which can serve as a helpful foundation for your own UI projects.

#### Web SDKs
- [React](https://github.com/dyte-io/react-samples/tree/main/samples/create-your-own-ui)

We’ll discuss the available SDKs, how they relate to each other, and how the provided code samples were built. We’ll also look at parts of the samples to better understand how the SDKs map to different features.
...
| React Native | [@cloudflare/realtimekit-react](https://www.npmjs.com/package/@cloudflare/realtimekit-react) | [@cloudflare/realtimekit-react-native](https://www.npmjs.com/package/@cloudflare/realtimekit-react-native) |
...
For Web, the base Core SDK is `@cloudflare/realtimekit` and the base UI Kit is `@cloudflare/realtimekit-ui`. The UI Kit is based on [Web Components](https://developer.mozilla.org/en-US/docs/Web/Web_Components) and built using [Stencil](https://stenciljs.com/). You can learn more in our open source [UI Kit Repo](https://github.com/dyte-io/realtimekit-ui).
...
4. **Session transitions**:
   ...
   - If the peer is kicked out, they see a Ended screen and the session ends for them.
...
`rtk-sidebar` is the sidebar component that shows the sidebar, in which chat, polls content showup.

You can split all of these components further. To see more such components, refer to our [components library](https://docs.realtime.cloudflare.com/react-ui-kit/components) or [ui-kit repo](https://github.com/dyte-io/realtimekit-ui).
...
We will be providing a code sample soon to make it easier for you.
...
You can split all of these components further. To see more such components, refer to our [components library](https://docs.realtime.cloudflare.com/react-ui-kit/components) and [ui-kit repo](https://github.com/dyte-io/realtimekit-ui).

To not bloat this page, we have kept the code simple here. You can see a complete sample [here](https://github.com/dyte-io/react-samples/tree/main/samples/create-your-own-ui).
