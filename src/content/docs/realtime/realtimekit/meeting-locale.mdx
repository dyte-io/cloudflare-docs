...
:::note[Prerequisites]
This page builds upon the [Render Default Meeting UI](/realtime/realtimekit/render-default-meeting-ui/) & [Build Your Own UI](/realtime/realtimekit/build-your-own-ui/) guides. Make sure you've read it first and understand how to use the default meeting UI components.
:::
